...
struct tAssignationFlatFull
{
	...
	char						 TotalAssets{ '\0' };					// xs:boolean: Нежилое помещение - общее имущество в многоквартирном доме (true - да)
	char						 AuxiliaryFlat{ '\0' };				// xs:boolean: Нежилое помещение - помещение вспомогательного использования (true - да)
